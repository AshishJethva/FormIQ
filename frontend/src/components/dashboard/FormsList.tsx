...
const FormsList: React.FC<FormsListProps> = ({
  ...
  const [currentFormMenuId, setCurrentFormMenuId] = useState<string | null>(
    null
  );
  ...
  const handleFormClick = useCallback(
    ...
    [clickedFormId, router, renamingFormId, selectedForms]
  );
      ...
      return (
        <>
          ...
          <Button
            variant='outline'
            size='sm'
            className='text-red-600 border-gray-300 hover:bg-red-50 cursor-pointer text-xs sm:text-sm px-2 sm:px-3'
    ...
    return (
      <>
        <Button
          variant='outline'
          size='sm'
          className='text-gray-700 border-gray-300 hover:bg-gray-100 cursor-pointer text-xs sm:text-sm px-2 sm:px-3'
  ...
  const MobileFormActions = ({ form }: { form: any }) => (
    <Sheet
      open={showMobileMenu && currentFormMenuId === form.id}
      onOpenChange={open => {
        setShowMobileMenu(open);
        if (!open) setCurrentFormMenuId(null);
      }}
    >
      ...
      <SheetContent side='bottom' className='bg-white text-black'>
        <SheetHeader>
          <SheetTitle className='text-left'>{form.name}</SheetTitle>
        </SheetHeader>
  ...
  return (
    <div className='space-y-2'>
      ...
      {selectedForms.length > 0 && (
        <div className='flex flex-col sm:flex-row items-start sm:items-center justify-between p-3 bg-[#EDF8FF] border border-blue-300 rounded-md mb-2 space-y-2 sm:space-y-0'>
          ...
          <div className='flex items-center space-x-1 sm:space-x-2 w-full sm:w-auto justify-end overflow-x-auto'>
      ...
      hover:bg-[#F3F3FE] hover:border-gray-300 hover:shadow-sm`}
          ...
          >
            <div className='flex items-center space-x-2 sm:space-x-3 min-w-0 flex-1'>
              ...
              */}
              ...
              <div className='min-w-0 flex-1'>
                ...
                <div className='text-xs text-gray-500 truncate flex flex-col sm:flex-row sm:items-center gap-1'>
                  <button
                    onClick={e => handleSubmissionsClick(e, form.id)}
                    className='text-[#2E66C3] hover:text-blue-800 hover:underline font-medium transition-colors inline-flex items-center gap-1 cursor-pointer self-start'
            ...
            <div className='ml-auto flex items-center space-x-2'>
              {/* Display labels if they exist - responsive layout */}
              {form.labels && form.labels.length > 0 && (
                <div className='hidden sm:flex mr-2 max-w-[120px] overflow-hidden'>
              ...
              {form.isTrashed && form.daysRemaining && (
                <div className='mr-2 px-2 py-0.5 bg-green-100 text-green-700 text-xs rounded-md whitespace-nowrap'>
      ...
      >
        <DialogContent className='sm:max-w-[425px] max-w-[95vw] bg-white text-black mx-auto'>
          <DialogHeader>
      ...
      >
        <AlertDialogContent className='max-w-2xl sm:max-w-2xl max-w-[95vw] bg-white text-gray-900 mx-auto'>
          ...
          <div className='text-gray-700 space-y-4 px-2 sm:px-6'>
            <div className='bg-red-50 border border-red-200 rounded-lg p-3 sm:p-4'>
              <span className='font-semibold text-red-800 mb-3 flex items-center gap-2 text-sm sm:text-base'>
              ...
              <div className='bg-yellow-50 border border-yellow-200 rounded p-3'>
                <span className='font-medium text-yellow-800 mb-2 flex items-center gap-1 text-sm'>
                  📊 Deletion Impact:
                </span>
                <div className='text-xs sm:text-sm text-yellow-700 space-y-1 mt-2'>
            ...
            <div className='bg-gray-100 border-l-4 border-red-500 p-3 sm:p-4'>
              <span className='font-bold text-red-700 flex items-center gap-2 text-sm sm:text-base'>
                <XCircle className='w-4 h-4 sm:w-5 sm:h-5' />
                THIS ACTION CANNOT BE UNDONE
              </span>
              <span className='text-gray-700 mt-2 block text-xs sm:text-sm'>
            ...
            <span className='text-center font-medium text-gray-900 block text-sm sm:text-base'>
          ...
          <AlertDialogFooter className='flex flex-col sm:flex-row gap-3'>
            <AlertDialogCancel
              ...
              className='border-gray-300 hover:bg-gray-50 px-4 sm:px-6 w-full sm:w-auto'
            >
              Cancel
            </AlertDialogCancel>
            ...
            <AlertDialogAction
              ...
              disabled={isDeletingCustom}
              className='bg-red-600 hover:bg-red-700 text-white px-4 sm:px-6 w-full sm:w-auto'
            >
              {isDeletingCustom ? (
