...
export default function ElementsPanel({
  ...
  }, [forceOpen, isExpanded, onPanelToggle]);
        ...
        {!isPanelExpanded && (
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className='group flex items-center cursor-pointer bg-gradient-to-r from-[#2C2F4A] to-[#3a4058] text-white px-3 py-2.5 sm:px-4 sm:py-3 rounded-r-full shadow-xl hover:shadow-2xl transition-all duration-300 border border-white/10 relative top-18 left-[-17]'
              onClick={togglePanel}
            >
            ...
            <div className='h-full bg-gradient-to-b from-[#33384A] via-[#2a2f42] to-[#1f2237] text-white shadow-2xl flex flex-col border-r border-white/10'>
              ...
              >
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.9 }}
                  className='p-2 rounded-full hover:bg-white/10 transition-all duration-200 group cursor-pointer'
                  onClick={togglePanel}
                >
