...
//   // Available timezone options (simplified list)
//   const timezones = [
...
//   const handleToggleEmailPreference = (
...
//             className='flex items-center bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded text-sm font-medium transition-colors cursor-pointer'
//           >
...
//                         className='block w-full p-2 pr-10 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 appearance-none'
//                       >
